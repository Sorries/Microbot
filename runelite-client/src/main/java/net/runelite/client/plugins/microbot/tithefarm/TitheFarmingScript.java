...
//                        new TitheFarmPlant(35, 28, 17),
//                        new TitheFarmPlant(40, 28, 18),
//                        new TitheFarmPlant(35, 31, 13),
//                        new TitheFarmPlant(40, 31, 14),
                        new TitheFarmPlant(35, 31, 15),
                        new TitheFarmPlant(40, 31, 16),
                        new TitheFarmPlant(35, 34, 17),
                        new TitheFarmPlant(40, 34, 18),
                        new TitheFarmPlant(35, 40, 1),
                        new TitheFarmPlant(40, 40, 2),
                        new TitheFarmPlant(35, 43, 3),
                        new TitheFarmPlant(40, 43, 4),
                        new TitheFarmPlant(35, 46, 5),
                        new TitheFarmPlant(40, 46, 6),
                        new TitheFarmPlant(35, 49, 7),
                        new TitheFarmPlant(40, 49, 8),
                        new TitheFarmPlant(45, 49, 9),
                        new TitheFarmPlant(45, 46, 10),
                        new TitheFarmPlant(45, 43, 11),
                        new TitheFarmPlant(45, 40, 12)));
                break;
            case LANE_2_3:
                plants = new ArrayList<>(Arrays.asList(
