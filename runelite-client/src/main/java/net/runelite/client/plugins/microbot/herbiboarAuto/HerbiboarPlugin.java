package net.runelite.client.plugins.microbot.herbiboarAuto;
...
public class HerbiboarPlugin extends Plugin {
    ...
    public void updateTrailData()
    {
        ...
        Microbot.log("finishId = "+finishId+", started = "+started+", currentGroup = "+currentGroup + " path active: "+pathActive);
        if (finished)
        {
            resetTrailData();
        }
